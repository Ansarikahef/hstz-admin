...
export default function Register() {
  ...
  const onSubmit = async (ev) => {
    ...
    try{
      const { status, message, responseValue } = await apiService.post("users/create", payload);
      if (status) {
        toast.success("Account created successfully!");
       // navigate(`/travellers/${responseValue.id}`);
      } else {
  ...
  return (
    ...
    <div className="" data-testid="register-page">
